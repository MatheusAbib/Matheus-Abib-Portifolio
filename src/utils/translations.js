const translations = {
  pt: {
    ...
    exp_1_text: "<ul><li>Configuração e testes de qualidade (QA) em sistemas de chatbot corporativo.</li><li>Atendimento direto com clientes para levantamento de necessidades e resolução de problemas técnicos.</li><li>Organização do fluxo de tarefas com Trello, garantindo prazos e qualidade.</li></ul>",
    ...
    certificate_modal_title: "Certificado",
    ...
    project_links_desc: "Projetos organizados em categorias (Figma e Power BI), com links diretos para cada trabalho. Inclui modal 'Sobre mim' com informações profissionais, hard skills e certificado power bi.",
    ...
    contact_info_text: "Estou disponível para novos projetos e oportunidades.",
    ...
    form_placeholder_email: "Digite seu email",
    form_placeholder_subject: "Qual o assunto da mensagem?",
    form_placeholder_phone: "Digite seu telefone",
  ...
  en: {
    ...
    exp_1_title: "BootComp Technology",
    exp_1_role: "Technical Support",
    exp_1_period: "2023 - 2024",
    exp_1_text: "<ul><li>Configuration and quality assurance (QA) testing in corporate chatbot systems.</li><li>Direct customer support for requirements gathering and technical issue resolution.</li><li>Task workflow organization using Trello, ensuring deadlines and quality delivery.</li></ul>",
    ...
    certificate_modal_title: "Certificate",
    ...
    project_imperator: "Imperatore - Management System",
    ...
    project_desfumo: "Desfumo - Smoking Cessation Control",
    ...
    project_links_desc: "Projects organized by categories (Figma and Power BI) with direct links to each work. Includes interactive 'About me' modal with professional information, hard skills and certificate.",
    ...
    contact_info_text: "I'm available for new projects and opportunities.",
...
form_placeholder_subject: "What is the subject of the message?",
