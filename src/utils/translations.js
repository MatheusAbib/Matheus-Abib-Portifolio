...
hero_desc_4: "Neste portfólio, você encontrará meus projetos, experiências e um pouco da minha evolução como programador.",
...
exp_1_text: "<ul><li>Configuração e testes de qualidade (QA) em sistemas de chatbot corporativos.</li><li>Atendimento direto com clientes para levantamento de necessidades e resolução de problemas técnicos.</li><li>Organização do fluxo de tarefas com Trello, garantindo prazos e qualidade.</li></ul>",
exp_2_title: "Prefeitura de Mogi das Cruzes",
exp_2_role: "Estágio em Desenvolvimento de Software",
exp_2_period: "2025 - Presente",
exp_2_text: "<ul><li>Desenvolvimento de aplicações para as secretarias de Mogi das Cruzes, automatizando fluxos de trabalho e melhorando a eficiência operacional.</li><li>Utilização de Angular, TypeScript e Spring Boot.</li><li>Planejamento e criação de interfaces com foco na experiência do usuário (UX), priorizando usabilidade e eficiência dos sistemas.</li><li>Levantamento de requisitos diretamente com os setores internos para garantir soluções alinhadas às necessidades reais.</li><li>Atuação em projetos utilizando a metodologia ágil Scrum.</li></ul>",
...
hero_desc_1: "<strong>Software developer</strong> with about 4 years of experience in the technology field, focused on developing applications using <strong>front-end and back-end</strong> technologies in projects ranging from systems for the Mogi das Cruzes City Hall to personal applications that I published and used to learn by doing.",
...
hero_desc_4: "Here in this portfolio, you will find my projects, experiences, and a little more about my evolution as a developer.",
    cv_button: "Download CV",
...
exp_2_text: "<ul><li>Development of applications for the municipal departments of Mogi das Cruzes, automating workflows and improving operational efficiency.</li><li>Use of Angular, TypeScript, and Spring Boot.</li><li>Planning and designing user interfaces focused on user experience (UX), prioritizing usability and system efficiency.</li><li>Requirements gathering directly with internal departments to ensure solutions aligned with real needs.</li><li>Work in projects using the Scrum agile methodology.</li></ul>",    
